...
<head>
  ...
  <style>
    :root {
      --gradient: linear-gradient( 132.6deg,  rgba(71,139,214,1) 23.3%, rgba(37,216,211,1) 84.7% );;
    }
    body {
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan Zaimu App</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Login untuk gunakan Zaimu App</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
